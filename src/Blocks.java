...
public class Blocks {
    ...
    private final int notBrokeColor = (new Color(77, 83, 87)).getRGB();

    private int brokeKol = 0;
    ...
    public void setBrokeKol(int brokeKol) {
        this.brokeKol = brokeKol;
    }

    public Blocks(double koef, int height) {
        this.height = height;
        ...
        initBlocks((int) (70 * koef), (int) (160 * koef), (int) (115 * koef), colors, koef, height);
        initBlocks((int) (430 * koef), (int) (520 * koef), (int) (475 * koef), colors, koef, height);
